...
// nestedFunction has access to everything inside of myFunction because it is a part of it and therefor has access to the scope of it.
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
    ...
    array.forEach(descriptor =>{
      newArray.push(`name: ${descriptor.animal_name}, scientific: ${descriptor.scientific_name}`)
    });
    return newArray
  }
  ...
  */
  ...
  function lowerCaseNames(array){
    let lowerCaseArray = array.map(x => x.animal_name.toLowerCase())
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const lessThanFive = array.filter(x => x.population < 5)
    return lessThanFive
  }
  ...
  */
  ...
  function USApop(array){
    const totalPop = array.reduce((acc, x) => acc + x.population, 0);
    return totalPop
  }
...
function CuboidMaker(cuboidMeasurements){
  this.length = cuboidMeasurements.length;
  this.width = cuboidMeasurements.width;
  this.height = cuboidMeasurements.height;
}
...
class CuboidMakerTwo{
  constructor(cuboidMeasurements){
    this.length = cuboidMeasurements.length;
    this.width = cuboidMeasurements.width;
    this.height = cuboidMeasurements.height;
  }
